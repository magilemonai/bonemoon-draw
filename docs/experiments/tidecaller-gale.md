...
Code b077b9e with uncommitted changes in src or scripts. Rules 2026-09-06. Starter decks as shipped (daxon 30, lirielle 30, luigi 30, rorik 30, masque 30, shazz 30). Seeds: 20260906 + pairing x 104729 + pair x 7919, the seat swap at seed + 1, deck orders hashed per hero. Stamped 9/7/2026, 20:07:37 EDT.
...
|---|---|---|---|
| Daxon Lamn | +2.5 points | -1.3 to +6.3 | 200 |
| Lirielle Starwhisper | +0.0 points | -2.0 to +2.0 | 200 |
| Luigi Bonemoon | -1.5 points | -3.7 to +0.7 | 200 |
| Rorik Flamebeard | -1.5 points | -3.2 to +0.2 | 200 |
| Lord-Provost Elaina Masque | +0.0 points | -1.4 to +1.4 | 200 |
| Imperator Amegmon Shazz | +0.5 points | -0.5 to +1.5 | 200 |
