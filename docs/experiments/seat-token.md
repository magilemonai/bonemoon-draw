...
Code b077b9e with uncommitted changes in src or scripts. Rules 2026-09-06. Starter decks as shipped (daxon 30, lirielle 30, luigi 30, rorik 30, masque 30, shazz 30). Seeds: 20260906 + pairing x 104729 + pair x 7919, the seat swap at seed + 1, deck orders hashed per hero. Stamped 9/7/2026, 20:04:52 EDT.
...
|---|---|---|---|
| Daxon Lamn | +3.0 points | -3.4 to +9.4 | 200 |
| Lirielle Starwhisper | -4.0 points | -11.1 to +3.1 | 200 |
| Luigi Bonemoon | -2.5 points | -10.2 to +5.2 | 200 |
| Rorik Flamebeard | -0.5 points | -6.8 to +5.8 | 200 |
| Lord-Provost Elaina Masque | +6.5 points | -0.9 to +13.9 | 200 |
| Imperator Amegmon Shazz | -2.5 points | -8.6 to +3.6 | 200 |
